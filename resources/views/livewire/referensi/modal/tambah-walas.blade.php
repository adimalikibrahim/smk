<div>
    <div wire:ignore.self class="modal fade" id="tambahWalas" tabindex="-1" aria-labelledby="tambahWalasLabel"
        aria-hidden="true" data-bs-backdrop="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahWalasLabel">Anggota Rombel Kelas</h5>
