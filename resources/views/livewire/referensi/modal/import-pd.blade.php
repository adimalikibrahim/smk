<div>
    <div wire:ignore.self class="modal fade" id="pdModal" tabindex="-1" aria-labelledby="pdModalLabel"
        aria-hidden="true" data-bs-backdrop="true">
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pdModalLabel">Tambah Data {{$data}}</h5>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control form-control-sm @error('nis.'.$urut) is-invalid @enderror" wire:model.defer="nis.{{$urut}}" @error('nis.'.$urut) data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="{{$message}}" @enderror></td>
                                    <td><input type="text" class="form-control form-control-sm @error('nisn.'.$urut) is-invalid @enderror" wire:model.defer="nisn.{{$urut}}" @error('nisn.'.$urut) data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="{{$message}}" @enderror></td>
                                    <td>
