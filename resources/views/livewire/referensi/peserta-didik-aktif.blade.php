                    ...
                    <div class="row justify-content-between mb-2">
                        <div class="col-4">
                            <div class="d-inline" wire:ignore>
                                <select class="form-select" wire:model="filter_tingkat" data-pharaonic="select2"
                                    data-component-id="{{ $this->id }}" data-search-off="true"
                                    data-placeholder="== Filter Tingkat ==">
                        ...
                        <div class="col-4">
                            <div class="d-inline" wire:ignore>
                                <select class="form-select" id="filter_jurusan" wire:model="filter_jurusan"
                                    data-pharaonic="select2" data-component-id="{{ $this->id }}" data-search-off="true"
                                    data-placeholder="== Filter Jurusan ==">
                        ...
                        <div class="col-4">
                            <div class="d-inline" wire:ignore>
                                <select class="form-select" id="filter_rombel" wire:model="filter_rombel"
                                    data-pharaonic="select2" data-component-id="{{ $this->id }}" data-search-off="true"
                                    data-placeholder="== Filter Rombel ==">
